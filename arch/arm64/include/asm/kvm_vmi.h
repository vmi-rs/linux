...
/*
 * Breakpoint (BRK) monitoring. kvm_vmi_bp_monitoring() is read from
...
/*
 * Singlestep monitoring. kvm_vmi_singlestep_active() is read from the
 ...
 * kvm_vmi_begin_atomic_step() is called from the stage-2 fault path instead of
