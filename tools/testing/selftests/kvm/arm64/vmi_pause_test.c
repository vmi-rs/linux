...
/*
 * KVM VMI pause/unpause test (arm64)
 *
 ...
 *
 * The guest is an arch-neutral GUEST_SYNC counter; all pause control is
 * via the generic KVM_VMI_PAUSE_* ioctls, so this mirrors the x86 test.
 */
#include <errno.h>
#include <linux/kvm.h>
#include <pthread.h>
