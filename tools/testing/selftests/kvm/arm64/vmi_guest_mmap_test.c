 ...
 * getpagesize() so the test works on any ARM64 page-size configuration
 * (4K, 16K, or 64K); never a hardcoded 4K shift.
 *
...
/*
 * Host and guest page sizes may differ (e.g. host 4K or 16K, guest 4K
 * granule), so host and guest page sizes can differ. The
